...
public class ProductosDestacados {
    ...
    public ProductosDestacados(Context contexto, ArrayList<ProductosDestacados>psdata){

    }
    public ProductosDestacados(Integer id_product, String name_product, String precioVenta, String precioNormal, String f_discount, String f_new, String f_on_sale, String images) {
